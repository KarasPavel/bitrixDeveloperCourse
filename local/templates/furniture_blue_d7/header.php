...
<body>
	...
	<div id="panel"><?$APPLICATION->ShowPanel();?></div>
		<div id="header">
			...
			<table id="logo">
				<tr>
					<td><a href="<?=SITE_DIR?>" title="<?=Loc::getMessage('CFT_MAIN')?>"><?
...
<?$APPLICATION->IncludeComponent("bitrix:menu", "horizontal_multilevel", array(
	...
	"ACTIVE_COMPONENT" => "Y"
			...
			<div id="top-icons">
				<a href="<?=SITE_DIR?>" class="home-icon" title="<?=Loc::getMessage('CFT_MAIN')?>"></a>
				<a href="<?=SITE_DIR?>search/" class="search-icon" title="<?=Loc::getMessage('CFT_SEARCH')?>"></a>
				<a href="<?=SITE_DIR?>contacts/" class="feedback-icon" title="<?=Loc::getMessage('CFT_FEEDBACK')?>"></a>
			</div>
...
?>
				...
				<div class="information-block">
					...
					<div class="information-block-inner">
						<h3><?=Loc::getMessage('CFT_FEATURED')?></h3>
<?
$APPLICATION->IncludeFile(
